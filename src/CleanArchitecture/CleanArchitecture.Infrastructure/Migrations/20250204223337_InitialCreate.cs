        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    precio_por_mantenimiento_monto = table.Column<decimal>(type: "numeric", nullable: true),
                    precio_por_mantenimiento_tipo_moneda = table.Column<string>(type: "text", nullable: true),
                    ...
                    fecha_confirmacion = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    fecha_denegacion = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    fecha_completado = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    fecha_cancelacion = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
